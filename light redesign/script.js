document.addEventListener('DOMContentLoaded', function () {
  ...
  /* ══════════════════════════════════════
     Sidebar Links — Smooth scroll + close drawer on mobile
     ══════════════════════════════════════ */
  ...
  sidebarLinks.forEach(function (link) {
    link.addEventListener('click', function (e) {
      ...
      /* Native smooth scroll handles the actual scrolling via href="#id" */
    });
  });
  ...
  var delayClasses = ['delay-1','delay-2','delay-3','delay-4','delay-5','delay-6','delay-7'];
  ...
  staggerContainers.forEach(function (container) {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      for (var d = 0; d < delayClasses.length; d++) {
        if (children[i].classList.contains(delayClasses[d])) {
          hasDelay = true;
          break;
        }
      }
