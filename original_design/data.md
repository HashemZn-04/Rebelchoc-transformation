...
<!-- ══════════════ HERO ══════════════ -->
<section class="hero">
  <p class="hero-label reveal delay-1">Limited Edition Resistance Wear</p>
  <h1 class="hero-title reveal delay-2">The World</h1>
  <div class="hero-liberation reveal delay-3">Liberation<br>Day</div>

  <!-- IMAGE PLACEHOLDER: hero t-shirt mockup, front view with Manneken Pis print — suggested filename: hero-shirt.png -->
  <div class="img-placeholder hero-statue-placeholder reveal delay-4"><span>Hero T-Shirt Mockup</span></div>

  <div class="taglines reveal delay-5">
...
<section class="tradition">
  <div class="tradition-text reveal">
  ...
  <div class="tradition-img-wrap reveal delay-2">
...
<!-- ══════════════ 1619 ══════════════ -->
<section class="year-section year-section--1619">
  ...
  <div class="year-section-inner reveal">
...
<!-- ══════════════ 1938 ══════════════ -->
<section class="year-section year-section--1938">
...
<!-- ══════════════ 2026 ══════════════ -->
<section class="year-section year-section--2026">
...
<section class="resist-section">
  <h2 class="year-title reveal">2026</h2>
  <p class="resist-heading reveal delay-1">JOIN THE REBEL RESISTANCE</p>
  <p class="resist-heading reveal delay-2">RESIST, REJECT, REACT</p>
  <p class="resist-text reveal delay-3">Against coercion and international unlawful use of military power,</p>
  <p class="resist-emphasis reveal delay-4">UNTIL THE WORLD LIBERATION DAY OCCURS</p>
  <p class="resist-quote reveal delay-5">With humour we rebel, with humour we resist the lies, we reject the destruction, we react to support international and multilateral organisations that promote peace, solidarity and problem solving through negotiation</p>
</section>

<!-- ══════════════ HOW TO REACT ══════════════ -->
<section class="how-section">
  <div class="how-inner">
    <h2 class="how-title reveal">HOW TO REACT</h2>
    <div class="how-rule reveal delay-1"></div>
    <p class="how-subtitle reveal delay-2">Let's show our solidarity through:</p>
    <p class="how-item reveal delay-3"><strong>SHARE</strong> the rebel humouristic ideals with everyone you know</p>
    <p class="how-item how-item--demonstrate reveal delay-4"><strong>DEMONSTRATE</strong> by buying and wearing this t-shirt symbol of resistance. Each purchase generates a €5 donation to international organisations that Daddy D wants to destroy.</p>
    <p class="how-item how-item--generate reveal delay-5"><strong>GENERATE</strong> new humouristic ideas this extremism could inspire. Share them with us.</p>
  </div>
</section>

<!-- ══════════════ LET'S REACT ══════════════ -->
<section class="lets-react-section">
  <p class="lr-title reveal">LET'S REACT</p>
  <p class="lr-subtitle reveal delay-1">SHARE CREATIVE IDEAS</p>
  <p class="lr-lead reveal delay-2">such as</p>
  <p class="lr-question reveal delay-3">Which international or/and Nobel Prizes Donald deserves?</p>
  <p class="lr-question reveal delay-4">Which advises will you give to Daddy D?</p>
  <p class="lr-final reveal delay-5">HUMOUR IS MORE POWERFUL THAN NUCLEAR BOMB</p>
</section>

<!-- ══════════════ NOBEL REBEL PRIZES ══════════════ -->
<section class="nobel">
  <div class="section-inner">
    <p class="section-label reveal">Satirical Awards</p>
    <h2 class="section-title reveal delay-1">The Nobel<br>Rebel Prize</h2>
    <div class="rule reveal delay-2"></div>
    <p class="nobel-intro reveal delay-3">Give Your Noble Rebel Prize<br>to Don Dorleone</p>

    <div class="nobel-grid reveal-stagger">
    ...
    <blockquote class="solidarity reveal">
...
<section class="order" id="order">
  <div class="section-inner order-header reveal">
  ...
  <div class="order-card reveal delay-2">
    ...
    <div class="donate-badge">
      <!-- SVG heart icon replacing emoji -->
      <svg class="donate-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
      <span>€5 of each purchase donated to UNICEF &amp; Red Cross</span>
    </div>
...
<section class="why">
  <div class="section-inner">
    <div class="why-grid reveal-stagger">
      <div class="why-item">
        <!-- SVG t-shirt icon replacing emoji -->
        <div class="why-icon">
      ...
      <div class="why-item">
        <!-- SVG lightning icon replacing emoji -->
        <div class="why-icon">
...
<footer class="reveal">
  ...
  <p class="footer-copy">&copy; <span id="current-year">2026</span> Rebel Choc &middot; www.rebelchoc.com &middot; Brussels, Belgium</p>
</footer>
...
/* Explicit delay utilities (override JS-set stagger delays) */
...
.delay-5 { transition-delay: 0.55s !important; }
.delay-6 { transition-delay: 0.70s !important; }
.delay-7 { transition-delay: 0.85s !important; }
...
.hero::before {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(ellipse 90% 70% at 50% 40%, rgba(255, 191, 0, 0.07) 0%, transparent 70%);
  pointer-events: none;
...
.year-section--1619 { background-color: var(--gold); }
.year-section--1938 { background-color: #7a3a1a; }
.year-section--2026 { background-color: var(--gold); }
...
.how-item--generate { color: var(--gold-dim); margin-bottom: 0; }
...
.nobel-item:hover {
  ...
  background: rgba(74, 34, 6, 0.9);
  transform: translateX(4px);
}
/* CSS diamond bullet replacing Unicode star */
.nobel-item::before {
  content: '';
  width: 6px;
  height: 6px;
...
/* Buy button with subtle pulse */
@keyframes cta-pulse {
  0%, 100% { box-shadow: 0 4px 28px rgba(255, 191, 0, 0.2); }
  50% { box-shadow: 0 6px 42px rgba(255, 191, 0, 0.4); }
}
.btn-buy {
  display: block;
  width: 100%;
...
.btn-buy:hover {
  background: #ffd040;
  transform: translateY(-2px);
  box-shadow: 0 10px 40px rgba(255, 191, 0, 0.4);
  animation: none;
}
.btn-buy:active {
  transform: translateY(0);
...
@media (max-width: 640px) {
  ...
  .resist-section,
  .how-section,
  .lets-react-section { padding: 72px 20px; }
